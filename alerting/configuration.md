...
## `<inhibit_rule>` <a id="inhibit_rule"></a>
...
## `<http_config>` <a id="http_config"></a>
...
## `<email_config>` <a id="email_config"></a>
...
## `<hipchat_config>` <a id="hipchat_config"></a>
...
## `<pagerduty_config>` <a id="pagerduty_config"></a>
...
### `<image_config>` <a id="image_config"></a>
...
### `<link_config>` <a id="link_config"></a>
...
## `<pushover_config>` <a id="pushover_config"></a>
...
## `<slack_config>` <a id="slack_config"></a>
...
### `<action_config>` <a id="action_config"></a>

这些字段记录在 Slack API 文档中，用于[附件消息](https://api.slack.com/docs/message-attachments#action_fields)和[交互式消息](https://api.slack.com/docs/interactive-message-field-guide#action_fields).
...
#### `<action_confirm_field_config>` <a id="action_confirm_field_config"></a>

这些字段记录在 [Slack API 文档](https://api.slack.com/docs/interactive-message-field-guide#confirmation_fields)中。
...
### `<field_config>` <a id="field_config"></a>
...
## `<opsgenie_config>` <a id="opsgenie_config"></a>
...
## `<victorops_config>` <a id="victorops_config"></a>
...
## `<webhook_config>` <a id="webhook_config"></a>
...
微信通知通过[微信 API](https://admin.wechat.com/wiki/index.php?title=Customer_Service_Messages) 发送。
