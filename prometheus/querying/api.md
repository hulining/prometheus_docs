...
### 范围查询 <a href="#range-queries" id="range-queries"></a>
...
有关`<value>`占位符的格式，请参见[范围向量结果格式](https://app.gitbook.com/s/-M4S\_SROsX9DJxfYcGcT-3598119973/prometheus/querying/api.md#range-vectors)。
...
## 查询目标元数据 <a href="#querying-target-metadata" id="querying-target-metadata"></a>
